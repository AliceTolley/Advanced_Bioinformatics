...
reaction_time
# Answer = the average reaction time is 0.0879332 seconds
...
# Principle Component 2 shows a 13% variance between the lowest sample cluster in group KOb and the highest sample cluster in group KOa.
